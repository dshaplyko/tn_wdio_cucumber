...
Scenario: 1. Verifying items on Main page as a visitor
   ...
   Then the list of notes should be displayed
    And the 'Filter' element is visible on the Main page
    And the 'Toggle' element is not visible on the Main page
...
Scenario: 1. Verifying items on Main page as a logged in user
   ...
   Then the list of notes should be displayed
    And the 'Filter' element is visible on the Main page
    And the 'Toggle' element is visible on the Main page
    And each of note entry has 'title'
    And each of note entry has 'substile'
